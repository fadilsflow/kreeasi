  ...
  return (
    <footer className="border-b pt-20">
      <div className="mb-8 border-b md:mb-12">
        <div className="mx-auto max-w-2xl md:max-w-3xl lg:max-w-7xl px-4 lg:px-6 flex flex-wrap items-end justify-between gap-6  pb-6">
      ...
      <div className="mx-auto max-w-2xl md:max-w-3xl lg:max-w-7xl px-4 lg:px-6">
        ...
        <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
          <small className="text-muted-foreground order-last block text-center text-sm md:order-first">
            © {new Date().getFullYear()} Kreeasi, All rights reserved
          </small>
